  ...
  Future<void> _exportToExcel() async {
    ...
    try {
      ...
      sheet.appendRow([
        ...
        excel_pkg.IntCellValue(attend),
      ]);
      sheet.appendRow([
        excel_pkg.TextCellValue('غائب'),
        excel_pkg.IntCellValue(absent),
      ]);
      sheet.appendRow([
        excel_pkg.TextCellValue('معتذر'),
        excel_pkg.IntCellValue(excuse),
      ]);
      sheet.appendRow([
        ...
        pw.MultiPage(
          build: (context) => [
            ...
            pw.TableHelper.fromTextArray(
              ...
              data: [
                ['حاضر', attend.toString()],
                ['غائب', absent.toString()],
                ['معتذر', excuse.toString()],
                ['المجموع', (attend + absent + excuse).toString()],
              ],
